...
また、マイページでは上部の「プロフィール編集」からご自身の「ユーザー名」「ユーザーID」「プロフィール」「ユーザーアイコン」を変更することが出来ます。  
「ユーザーアイコン」の変更はフォーム内の左上のアイコン(初期アイコンは灰色の人)をクリックすることで変更出来ます。
変更時にもとのアイコンが変更予定のものに置き換わりますので、プレビューとしてご利用ください。
